...
% now we have, for each spatial bin:
    % 1) a vector of occupancy trials
    % 2) a vector of spike counts in that trial
    % 3) a vector of reward counts (i.e. reward quantity) in that trial

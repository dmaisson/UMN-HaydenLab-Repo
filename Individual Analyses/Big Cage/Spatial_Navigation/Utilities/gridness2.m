function [grid_score, rotations] = gridness2(autocorrelogram)
...
rotations = 0:6:180;[30 50 60 90 120];
...
rotations(2,:) = r;
group1(:,1) = rotations(:,rotations(1,:)==60);
group1(:,2) = rotations(:,rotations(1,:)==120);
group2(:,1) = rotations(:,rotations(1,:)==30); 
group2(:,2) = rotations(:,rotations(1,:)==50); 
group2(:,3) = rotations(:,rotations(1,:)==90); 

function [out] = MultiReg_shuffle(data,epoch1,ms)
%% Value definition
[epoch2,epoch3] = epochs(epoch1,ms);
...
%     R.Epoch1.b.SideEVreg(iL,1) = z(3,1); %betas from Epoch1 FR on side of first
    R.Epoch1.b.Choice(iL,1) = z(4,1); %betas from Epoch1 FR on choice
...
%     R.Epoch2.b.SideEVreg(iL,1) = z(4,1); %betas from Epoch2 FR on side of first
    R.Epoch2.b.Choice(iL,1) = z(5,1); %betas from Epoch2 FR on choice
...
R.Integ.E1format = corr(R.Epoch1.b.prob1,R.Epoch1.b.size1,'Type','Pearson');
R.Integ.E1pop = corr(abs(R.Epoch1.b.prob1),abs(R.Epoch1.b.size1),'Type','Pearson');
...
R.Inhib.EVformat = corr(R.Epoch2.b.EV1,R.Epoch2.b.EV2,'Type','Pearson');
R.Inhib.EVpop = corr(abs(R.Epoch2.b.EV1),abs(R.Epoch2.b.EV2),'Type','Pearson');

%Alignment (EV of Epoch in respective Epoch)
R.Alignformat = corr(R.Epoch1.b.EV1,R.Epoch2.b.EV2,'Type','Pearson');
R.Alignpop = corr(abs(R.Epoch1.b.EV1),abs(R.Epoch2.b.EV2),'Type','Pearson');

%WM (EV1 in both Epochs)
R.WMformat = corr(R.Epoch1.b.EV1,R.Epoch2.b.EV1,'Type','Pearson');
R.WMpop = corr(abs(R.Epoch1.b.EV1),abs(R.Epoch2.b.EV1),'Type','Pearson');

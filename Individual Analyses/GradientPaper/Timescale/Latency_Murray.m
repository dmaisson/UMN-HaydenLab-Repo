function [L] = Latency_Murray(start)
%% Instructions
...
clear iJ iK iL temp temp_avg lag;
lag(1:9,1) = [40,80,120,160,200,240,280,320,360];
hold on; plot(lag,auto, 'o');

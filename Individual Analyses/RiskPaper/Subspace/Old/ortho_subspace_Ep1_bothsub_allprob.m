function R = ortho_subspace_Ep1_bothsub_allprob(subject1,subject2,range,sv)
...
[R{iI}.PCs.safelow,R{iI}.VarE.safelow,R{iI}.projected1.safelow, R{iI}.projected2.safelow] = ...
    project_to_lowD_DM(safemat, lowmat);
[R{iI}.PCs.lowsafe,R{iI}.VarE.lowsafe,R{iI}.projected1.lowsafe, R{iI}.projected2.lowsafe] = ...
    project_to_lowD_DM(lowmat, safemat);

[R{iI}.PCs.safehigh,R{iI}.VarE.safehigh,R{iI}.projected1.safehigh, R{iI}.projected2.safehigh] = ...
    project_to_lowD_DM(safemat, highmat);
[R{iI}.PCs.highsafe,R{iI}.VarE.highsafe,R{iI}.projected1.highsafe, R{iI}.projected2.highsafe] = ...
    project_to_lowD_DM(highmat, safemat);

%% Collect
R{iI}.safemat = safemat;
R{iI}.lowmat = lowmat;
R{iI}.highmat = highmat;
end
